...
export function ComplexArithmeticTest({ question, selectedAnswer, onAnswer }: Props) {
  return (
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        {question.choices.map((choice) => (
          <button
            ...
            className={`flex min-h-[64px] items-center justify-center rounded-2xl border text-lg font-semibold transition-all ${selectedAnswer === choice
