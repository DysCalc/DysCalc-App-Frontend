...
export default function EducatorReportsDashboard() {
  ...
  return (
    <div className="flex h-full w-full flex-col bg-[#F7F7F7] overflow-y-auto">
      <div ref={reportRef} className="flex flex-col bg-[#F7F7F7] min-h-max">
        {/* Header */}
        ...
        <div className="flex-1 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#E7E7E7] flex gap-4">
              <div className="p-4 bg-[#ECF9F4] rounded-xl text-[#29A177] h-fit">
              ...
              <div className="flex flex-col justify-center">
                ...
                <p className="text-xs text-zinc-400 mt-1">{classFilter === "ALL" ? "Across all classrooms" : "In the selected classroom"}</p>
              </div>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#E7E7E7] flex gap-4">
              <div className="p-4 bg-blue-50 rounded-xl text-blue-600 h-fit">
              ...
              <div className="flex flex-col justify-center">
                ...
                <p className="text-xs text-zinc-400 mt-1">Total completed assessments</p>
              </div>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#E7E7E7] flex gap-4">
              <div className={`p-4 rounded-xl h-fit ${metrics.atRiskPercentage > 30 ? 'bg-red-50 text-red-600' : 'bg-amber-50 text-amber-600'}`}>
              ...
              <div className="flex flex-col justify-center">
                ...
                <p className="text-xs text-zinc-400 mt-1">Students who scored below the dyscalculia threshold. Consider scheduling an intervention.</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#E7E7E7] lg:col-span-1 flex flex-col">
              <h3 className="text-lg font-bold text-zinc-700">Risk Distribution</h3>
              <p className="text-xs text-zinc-500 mt-1 mb-6">This chart shows the proportion of students classified as At-Risk vs. Typical based on their assessment scores.</p>
              <div className="h-64">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#E7E7E7] lg:col-span-2 flex flex-col">
              <div className="flex justify-between items-start mb-2">
                <div>
                  ...
                  <p className="text-xs text-zinc-500 mt-1">Average class score per skill area. Lower scores indicate where most students need support.</p>
                </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#E7E7E7]">
            <div className="mb-6">
              ...
              <p className="text-xs text-zinc-500 mt-1 ml-7">These are re-assessments assigned to students who showed difficulty in specific skills.</p>
            </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#E7E7E7] mt-8">
            <div className="mb-6">
              ...
              <p className="text-xs text-zinc-500 mt-1 ml-11">
                These student retests are complete but need your review before results are recorded.
              </p>
            </div>
